 ...
 * @author GF63
 */
public class T_P_H_A {
    
    String [] Current_login_info;
    public T_P_H_A(String[] array){
    ...
    public void readfile() throws IOException{
        ...
        while ((line=br.readLine())!=null){
            ...
            if(record[2].equals(Current_login_info[0])&& record[3].equals(Current_login_info[1]) && record[10].equals("Paid")){
                Personal_record=Arrays.copyOf(Personal_record, Personal_record.length+1);
                Personal_record[Personal_record.length-1]=new String[]{record[0],record[1],record[4],record[5],record[6],record[9]};
